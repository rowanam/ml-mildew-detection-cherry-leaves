...
def page_summary_body():
    ...
    st.write(
        """The project client, Farmy & Foods, is facing a challenge where 
        their **cherry tree plantations have been presenting powdery mildew**, 
        a fungal disease that affects many plant species."""
    )
    st.write(
        """The current verification of whether a given cherry tree contains 
        powdery mildew is a time-consuming manual approach, which is not scalable 
        to thousands of trees across multiple farms. However, trees with powdery 
        mildew need to be identified in order to apply a compound to kill the 
        fungus."""
    )

    st.info(
        """To save time in this process, the client requests a Machine Learning 
        system that can detect instantly from a leaf image whether a tree is 
        healthy or has powdery mildew."""
    )
    ...
    st.write(
        """A successful project will help the client minimize the amount of 
    ...
    st.write(
        ...
        [project README]
        (https://github.com/rowanam/ml-mildew-detection-cherry-leaves) 
        on GitHub.*"""
    )
